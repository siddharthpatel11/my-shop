                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                name="code" value="{{ old('code', $discount->code) }}" style="text-transform: uppercase;"
                                required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="value" class="form-label">
                                ...
                                <span id="value-unit">(in {{ $discount->type === 'percentage' ? '%' : '₹' }})</span>
                            </label>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0"
                                ...
                                name="min_amount" value="{{ old('min_amount', $discount->min_amount) }}" required>
